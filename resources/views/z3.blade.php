@extends('zsidebar')
@section('konten')
<h1 class="text-center py-10 text-2xl font-bold">LAPORAN DATA CV SKY</h1>
<a href="{{route ('lp2') }}" class="p-2 bg-pink-500 my-6 ml-32 text-white rounded-lg hover:bg-pink-600">Cetak Laporan</a><br><br>
<center>
