...
<body>
    ...
    <div class="text-center font-bold bg-[#61A3BA] my-10 mx-64 py-5 text-white">Masukan Data Diri Anda</div>
    

<div class="ml-56">
<form method="post" action="/cv/store2" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="flex pb-4">
    <div class="w-1/2" >
...
<input type="submit" value="Buat" class="bg-[#61A3BA] py-3 rounded-md px-36 font-bold text-white mx-64 mt-7 hover:bg-[#FF8050]">
</form>
</div>
